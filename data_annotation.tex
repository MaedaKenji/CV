...
\resumeProject
{Tree Canopy Detection System} % Project Name
{An automated tree canopy detection system using deep learning and drones for efficient forest monitoring.} % Project Description
{} % Event Dates
{}
\resumeItemListStart
    \item {Developed an automated tree canopy detection system using deep learning and drones for efficient forest monitoring.}
    \item {Curated and annotated a custom dataset of drone-captured forest imagery using {Roboflow}, implementing manual bounding box labeling for diverse tree species.}
    \item {Applied specialized data augmentation techniques (rotation, brightness adjustment, and mosaic) to improve model robustness against varying lighting conditions and aerial perspectives.}
    \item {Implemented a {YOLOv12} model for high-precision object detection and classification on tree canopies.}
    \item {Technology Used: Python, Ultralytics, {Roboflow}, OpenCV, and Deep Learning.}
\resumeItemListEnd
\vspace{-2mm}
